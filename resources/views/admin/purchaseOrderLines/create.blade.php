...
@section('title',__('views.admin.purchase.order.create.title'))
            ...
            {{ Form::open(['route'=>['admin.purchase.order.lines.insert'], 'method' => 'post','class'=>'form-horizontal form-label-left']) }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="qty" type="text" class="form-control col-md-7 col-xs-12 @if($errors->has('name')) parsley-error @endif"
                               name="qty" required>
                        @if($errors->has('qty'))
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="price" type="text" class="form-control col-md-7 col-xs-12 @if($errors->has('name')) parsley-error @endif"
                               name="price" required>
                        @if($errors->has('price'))
                            <ul class="parsley-errors-list filled">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="discount" type="text" class="form-control col-md-7 col-xs-12 @if($errors->has('name')) parsley-error @endif"
